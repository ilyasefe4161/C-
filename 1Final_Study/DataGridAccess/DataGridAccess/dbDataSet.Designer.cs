...
namespace DataGridAccess {
    ...
    public partial class dbDataSet : global::System.Data.DataSet {
        ...
        public partial class PersonelDataTable : global::System.Data.TypedTableBase<PersonelRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public PersonelRow AddPersonelRow(string Name, string Surname, string Mail, string Position) {
        ...
        public partial class PersonelRow : global::System.Data.DataRow {
            ...
            public string Position {
                get {
                    try {
                        return ((string)(this[this.tablePersonel.PositionColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'Position\' in table \'Personel\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tablePersonel.PositionColumn] = value;
                }
            }
            ...
            public bool IsPositionNull() {
                return this.IsNull(this.tablePersonel.PositionColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public void SetPositionNull() {
                this[this.tablePersonel.PositionColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace DataGridAccess.dbDataSetTableAdapters {
    ...
    public partial class PersonelTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `Personel` WHERE ((`ID` = ?) AND ((? = 1 AND `Name` IS NULL) OR (`Nam" +
                "e` = ?)) AND ((? = 1 AND `Surname` IS NULL) OR (`Surname` = ?)) AND ((? = 1 AND " +
                "`Mail` IS NULL) OR (`Mail` = ?)) AND ((? = 1 AND `Position` IS NULL) OR (`Positi" +
                "on` = ?)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Personel` (`Name`, `Surname`, `Mail`, `Position`) VALUES (?, ?, ?, ?" +
                ")";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `Personel` SET `Name` = ?, `Surname` = ?, `Mail` = ?, `Position` = ? WHERE ((`ID` = ?) AND ((? = 1 AND `Name` IS NULL) OR (`Name` = ?)) AND ((? = 1 AND `Surname` IS NULL) OR (`Surname` = ?)) AND ((? = 1 AND `Mail` IS NULL) OR (`Mail` = ?)) AND ((? = 1 AND `Position` IS NULL) OR (`Position` = ?)))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::DataGridAccess.Properties.Settings.Default.dbConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, Name, Surname, Mail, Position FROM Personel";
        ...
        public virtual int Delete(int Original_ID, string Original_Name, string Original_Surname, string Original_Mail, string Original_Position) {
        ...
        public virtual int Insert(string Name, string Surname, string Mail, string Position) {
            if ((Name == null)) {
        ...
        public virtual int Update(string Name, string Surname, string Mail, string Position, int Original_ID, string Original_Name, string Original_Surname, string Original_Mail, string Original_Position) {
            if ((Name == null)) {
